...
// Send Withdraw Form
const SendWithdrawForm: React.FC<TransactionFormProps> = ({
  onSubmit,
  multisigAddress = "",
}) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    onSubmit({ type: "lstv2-send-withdraw", multisigAddress, contractAddress, amount });
  };
...
export default SendWithdrawForm;
